...
Fork of (https://github.com/KhronosGroup/glTF-Sample-Models) intended for archive / convenience

All licensing as original. See original repo in KhronosGroup if unsure.
